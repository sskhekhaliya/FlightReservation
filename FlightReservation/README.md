...
- 🏷️ **Dynamic Pricing & Tax Computation**: Automatic calculation of base airfare, duration, and GST (18%) with real-time grand total breakdown.
...
- 🎟️ **Instant Seat Inventory Allocation**: Atomic decrementation of available seats upon successful booking with protection against overbooking.
...
- ✈️ **Airline & Fleet Management**: Full CRUD capabilities for carrier profiles, flight numbers, airline branding/logos, and aircraft specifications.
- 🗓️ **Route Scheduling & Inventory Dispatcher**: Interactive schedule planner equipped with Select2 searchable dropdowns to set flight routes, boarding/departure timestamps, seat quotas, and cabin-specific fares.
